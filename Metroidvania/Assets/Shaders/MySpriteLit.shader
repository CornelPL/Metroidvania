Shader "Lightweight Render Pipeline/2D/MySpriteLit"
{
	Properties
	{
...
#include "Packages/com.unity.render-pipelines.lightweight/ShaderLibrary/Core.hlsl"
		...
		SubShader
	{
		Tags {"Queue" = "Transparent" "RenderType" = "Transparent" "RenderPipeline" = "LightweightPipeline" "DisableBatching" = "True" }
